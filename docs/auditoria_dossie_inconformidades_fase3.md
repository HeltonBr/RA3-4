...
Situacao apos a conversa de 15/05/2026: `//` foi confirmado como operador aceito de divisao inteira, e `0` foi confirmado pelo professor como inteiro positivo para a regra de potenciacao. Os itens abaixo permanecem como rastreio do que foi perguntado ou ainda merece confirmacao fina.
...
7. **INC-17 - potenciacao:** resolvido parcialmente; `0` e aceito como inteiro positivo nesta linguagem. Para expoente vindo de memoria ou expressao, o codigo garante estaticamente o tipo `int`.
...
- **Tratamento adotado:** expoente deve ser `int`; base deve ser numerica; expoente literal `0` e aceito como inteiro positivo nesta linguagem por orientacao do professor. Expoente vindo de memoria ou expressao tem tipo verificado como `int`.
