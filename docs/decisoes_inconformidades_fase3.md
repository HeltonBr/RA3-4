...
| INC-07 | Ha tres arquivos validos completos em `teste1.txt`, `teste2.txt`, `teste3.txt`; um invalido semantico em `teste4_semantico_invalido.txt`; um invalido lexico em `teste5_lexico_invalido.txt`; e um invalido sintatico em `teste6_sintatico_invalido.txt`. Todos ficam na raiz, junto de `AnalisadorSemantico.py`, sem subpastas para entradas validas ou invalidas. |
