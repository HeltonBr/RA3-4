...
| INC-07 | Ha tres arquivos validos completos em `teste1.txt`, `teste2.txt`, `teste3.txt` e tres arquivos invalidos oficiais: `teste4_semantico_invalido.txt` para erros semanticos, `teste5_lexico_invalido.txt` para erros lexicos e `teste6_sintatico_invalido.txt` para erros sintaticos. Todos ficam na raiz, junto de `AnalisadorSemantico.py`, sem subpastas para entradas validas ou invalidas. |
...
| INC-15 | A validacao publica da entrega usa os arquivos oficiais da raiz, cobrindo programas validos e programas invalidos lexicos, sintaticos e semanticos. |
